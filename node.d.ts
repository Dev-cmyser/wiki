...
declare namespace $ {
    class $hyoo_crus_dom extends $hyoo_crus_node {
        ...
        selection(lord: $hyoo_crus_ref, next?: readonly (readonly [string, number])[]): readonly (readonly [string, number])[];
    }
}
...
declare namespace $ {
    class $mol_dom_range extends Object {
        ...
        static from_selection(sel?: Selection): $mol_dom_range;
...
declare namespace $ {
	...
	type $mol_hotkey__mod_ctrl_hyoo_crus_dom_edit_1 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_hotkey['mod_ctrl'] >
	>
	type $mol_hotkey__key_hyoo_crus_dom_edit_2 = $mol_type_enforce<
		({ 
			B( next?: ReturnType< $hyoo_crus_dom_edit['toggle'] > ): ReturnType< $hyoo_crus_dom_edit['toggle'] >,
			I( next?: ReturnType< $hyoo_crus_dom_edit['toggle'] > ): ReturnType< $hyoo_crus_dom_edit['toggle'] >,
			U( next?: ReturnType< $hyoo_crus_dom_edit['toggle'] > ): ReturnType< $hyoo_crus_dom_edit['toggle'] >,
			O( next?: ReturnType< $hyoo_crus_dom_edit['toggle'] > ): ReturnType< $hyoo_crus_dom_edit['toggle'] >,
			M( next?: ReturnType< $hyoo_crus_dom_edit['toggle'] > ): ReturnType< $hyoo_crus_dom_edit['toggle'] >,
		}) 
		,
		ReturnType< $mol_hotkey['key'] >
	>
	export class $hyoo_crus_dom_edit extends $mol_view {
		...
		node( ): $hyoo_crus_dom
		attr( ): ({ 
			'contenteditable': ReturnType< $hyoo_crus_dom_edit['editable'] >,
		}) 
		event( ): ({ 
			input( next?: ReturnType< $hyoo_crus_dom_edit['save'] > ): ReturnType< $hyoo_crus_dom_edit['save'] >,
		}) 
		enabled( ): boolean
		hint( ): string
		auto( ): readonly(any)[]
...
declare namespace $.$$ {
    class $hyoo_crus_dom_edit extends $.$hyoo_crus_dom_edit {
        ...
        selection_save(): void;
        selection_load(): void;
        toggle(Type: 'strong' | 'em' | 'ins' | 'del' | 'code', event: KeyboardEvent): void;
    }
}
...
declare namespace $ {
    const $wiki_note_base: Omit<typeof $hyoo_crus_entity, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_entity, {
        readonly Body: (auto?: any) => $hyoo_crus_dom | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            readonly Body: typeof $hyoo_crus_dom;
        };
    };
    export class $wiki_note extends $wiki_note_base {
    }
    export {};
}
...
declare namespace $ {
	...
	type $mol_string__hint_wiki_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_string['hint'] >
	>
	type $mol_string__value_wiki_2 = $mol_type_enforce<
		ReturnType< $wiki['note_title'] >
		,
		ReturnType< $mol_string['value'] >
	>
	type $mol_string__enabled_wiki_3 = $mol_type_enforce<
		ReturnType< $wiki['editing'] >
		,
		ReturnType< $mol_string['enabled'] >
	>
	type $mol_string__selection_wiki_4 = $mol_type_enforce<
		ReturnType< $wiki['title_selection'] >
		,
		ReturnType< $mol_string['selection'] >
	>
	type $mol_link_source__uri_wiki_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link_source['uri'] >
	>
	type $mol_button_minor__hint_wiki_6 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['hint'] >
	>
	type $mol_button_minor__click_wiki_7 = $mol_type_enforce<
		ReturnType< $wiki['add'] >
		,
		ReturnType< $mol_button_minor['click'] >
	>
	type $mol_button_minor__sub_wiki_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_minor['sub'] >
	>
	type $mol_check_icon__hint_wiki_9 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_check_icon['hint'] >
	>
	type $mol_check_icon__checked_wiki_10 = $mol_type_enforce<
		ReturnType< $wiki['editing'] >
		,
		ReturnType< $mol_check_icon['checked'] >
	>
	type $mol_check_icon__Icon_wiki_11 = $mol_type_enforce<
		ReturnType< $wiki['Edit_icon'] >
		,
		ReturnType< $mol_check_icon['Icon'] >
	>
	type $mol_link__hint_wiki_12 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_link['hint'] >
	>
	type $mol_link__arg_wiki_13 = $mol_type_enforce<
		ReturnType< $wiki['profile_arg'] >
		,
		ReturnType< $mol_link['arg'] >
	>
	type $mol_link__sub_wiki_14 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_link['sub'] >
	>
	type $hyoo_crus_dom_edit__hint_wiki_15 = $mol_type_enforce<
		string
		,
		ReturnType< $hyoo_crus_dom_edit['hint'] >
	>
	type $hyoo_crus_dom_edit__node_wiki_16 = $mol_type_enforce<
		ReturnType< $wiki['note_body'] >
		,
		ReturnType< $hyoo_crus_dom_edit['node'] >
	>
	type $hyoo_crus_dom_edit__enabled_wiki_17 = $mol_type_enforce<
		ReturnType< $wiki['editing'] >
		,
		ReturnType< $hyoo_crus_dom_edit['enabled'] >
	>
	type $mol_date__value_moment_wiki_18 = $mol_type_enforce<
		ReturnType< $wiki['note_changed_moment'] >
		,
		ReturnType< $mol_date['value_moment'] >
	>
	type $mol_date__enabled_wiki_19 = $mol_type_enforce<
		boolean
		,
		ReturnType< $mol_date['enabled'] >
	>
	type $mol_list__rows_wiki_20 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_page__title_wiki_21 = $mol_type_enforce<
		ReturnType< $wiki['note_title'] >
		,
		ReturnType< $mol_page['title'] >
	>
	type $mol_page__Title_wiki_22 = $mol_type_enforce<
		ReturnType< $wiki['Title'] >
		,
		ReturnType< $mol_page['Title'] >
	>
	type $mol_page__tools_wiki_23 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__body_wiki_24 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
...
declare namespace $.$$ {
    class $wiki extends $.$wiki {
        note(ref: $hyoo_crus_ref): $wiki_note;
        note_current(): $wiki_note;
        note_title(next?: string): string;
        note_body(): $hyoo_crus_dom;
        note_changed_moment(): $mol_time_moment;
