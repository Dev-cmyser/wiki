...
declare namespace $ {
	...
	export class $pixelbattle_workspace_board_pixel extends $mol_view {
		cellStyle( ): string
		toggleColor( next?: any ): any
		attr( ): ({ 
			'style': ReturnType< $pixelbattle_workspace_board_pixel['cellStyle'] >,
		}) 
		event( ): ({ 
			click( next?: ReturnType< $pixelbattle_workspace_board_pixel['toggleColor'] > ): ReturnType< $pixelbattle_workspace_board_pixel['toggleColor'] >,
		}) 
	}
	
}

//# sourceMappingURL=pixel.view.tree.d.ts.map
declare namespace $.$$ {
...
declare namespace $ {
	...
	export class $pixelbattle_workspace_board extends $mol_view {
		pixels( ): readonly(any)[]
		sub( ): ReturnType< $pixelbattle_workspace_board['pixels'] >
	}
...
declare namespace $.$$ {
    class $pixelbattle_workspace_board extends $.$pixelbattle_workspace_board {
        ...
        Pixel(id: string): $pixelbattle_workspace_board_pixel;
    }
}

declare namespace $ {

	export class $pixelbattle_workspace extends $mol_view {
		Board( ): $pixelbattle_workspace_board
		sub( ): readonly(any)[]
	}
	
}

//# sourceMappingURL=workspace.view.tree.d.ts.map
declare namespace $.$$ {
...
declare namespace $ {
	...
	type $mol_button_minor__title_pixelbattle_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_button_minor['title'] >
	>
	type $mol_page__plugins_pixelbattle_2 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['plugins'] >
	>
	type $mol_page__tools_pixelbattle_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['tools'] >
	>
	type $mol_page__body_pixelbattle_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['body'] >
	>
	type $mol_page__foot_pixelbattle_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_page['foot'] >
	>
	export class $pixelbattle extends $mol_example_large {
		hue_deg( ): string
		hue_spread_deg( ): string
		Theme( ): $mol_theme_auto
		Lights( ): $mol_lights_toggle
		Workspase( ): $pixelbattle_workspace
		Button_foot( ): $mol_button_minor
		Page( ): $mol_page
		title( ): string
		style( ): ({ 
			'--mol_theme_hue': ReturnType< $pixelbattle['hue_deg'] >,
			'--mol_theme_hue_spread': ReturnType< $pixelbattle['hue_spread_deg'] >,
		}) 
		sub( ): readonly(any)[]
	}
