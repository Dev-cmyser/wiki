namespace $.$$ {
	export class $pixelbattle_app extends $.$pixelbattle_app {
		@$mol_mem
		...
		@$mol_mem
		profile() {
			return this.$.$hyoo_crus_glob.home().hall_by($pixelbattle_person, {})
		}
		...
		@$mol_mem_key
		meet(id: string) {
			return this.$.$hyoo_crus_glob.Node($hyoo_crus_ref(id), $pixelbattle_meet)
		}
