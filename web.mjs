...
var $;
(function ($) {
    class $wiki_note extends $hyoo_crus_entity.with({
        Body: $hyoo_crus_dom,
    }) {
    }
    $.$wiki_note = $wiki_note;
...
;
	...
	($mol_mem(($.$wiki.prototype), "note_title"));
	($mol_mem(($.$wiki.prototype), "title_selection"));
	($mol_mem(($.$wiki.prototype), "Title"));
	($mol_mem(($.$wiki.prototype), "Lights"));
	($mol_mem(($.$wiki.prototype), "Source"));
	($mol_mem(($.$wiki.prototype), "add"));
	($mol_mem(($.$wiki.prototype), "Add_icon"));
	($mol_mem(($.$wiki.prototype), "Add"));
	($mol_mem(($.$wiki.prototype), "editing"));
	($mol_mem(($.$wiki.prototype), "Edit_icon"));
	($mol_mem(($.$wiki.prototype), "Edit_toggle"));
	($mol_mem(($.$wiki.prototype), "Profile_icon"));
	($mol_mem(($.$wiki.prototype), "Profile"));
	($mol_mem(($.$wiki.prototype), "note_body"));
	($mol_mem(($.$wiki.prototype), "Body"));
	($mol_mem(($.$wiki.prototype), "note_changed_moment"));
	($mol_mem(($.$wiki.prototype), "Note_changed_moment"));
	($mol_mem(($.$wiki.prototype), "Content"));
	($mol_mem(($.$wiki.prototype), "View_page"));
	($mol_mem_key(($.$wiki.prototype), "note"));
	($mol_mem(($.$wiki.prototype), "note_current"));
...
(function ($) {
    ...
    (function ($$) {
        class $wiki extends $.$wiki {
            note(ref) {
                return this.$.$hyoo_crus_glob.Node(ref, $wiki_note);
            }
            note_current() {
            ...
            profile_arg() {
                return {
                    '': this.$.$hyoo_crus_glob.home().hall_by($wiki_note, { '': $hyoo_crus_rank_read }).ref().description
                };
            }
            editing(next) {
        ...
        __decorate([
            $mol_mem_key
        ], $wiki.prototype, "note", null);
        __decorate([
            $mol_action
        ], $wiki.prototype, "add", null);
        __decorate([
            $mol_mem
        ], $wiki.prototype, "profile_arg", null);
        __decorate([
            $mol_mem
        ], $wiki.prototype, "editing", null);
        $$.$wiki = $wiki;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
