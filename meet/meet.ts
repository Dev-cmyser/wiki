namespace $ {
	export class $pixelbattle_meet extends $hyoo_crus_entity.with({
		Descr: $hyoo_crus_text,
		Owner: $hyoo_crus_atom_ref_to(() => $pixelbattle_person),
		Opinions: $hyoo_crus_atom_ref_to(() => $pixelbattle_meet_opinions),
	}) {
		@$mol_mem
		opinion_my() {
			...
			const opinion =
				opinions?.ensure_of(my_auth.peer(), {
	...
	export class $pixelbattle_meet_opinions extends $hyoo_crus_atom_ref_to(() => $pixelbattle_meet_opinion) {}

	export class $pixelbattle_meet_opinion extends $hyoo_crus_dict.with({
		Descr: $hyoo_crus_text,
	}) {}
}
